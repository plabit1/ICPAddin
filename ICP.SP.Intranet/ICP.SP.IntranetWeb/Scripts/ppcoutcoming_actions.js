            ...
            $.getScript(layoutsRoot + 'SP.js',
                function () {
                    ...
                    $.getScript(layoutsRoot + 'SP.RequestExecutor.js', function () {
                        ...
                        peoplePicker = new CAMControl.PeoplePicker(context, $('#spanAdministrators'), $('#inputAdministrators'), $('#divAdministratorsSearch'), $('#DBModel_RequestedByLogin'));
                        ...
                        $('#inAssignedBy').val($('#DBModel_RequestedByName').val());
