...
{
    public class OutlookTasksController : Controller
    {
        [Authorize]
        public async Task<ActionResult> Index()
        {
            ...
            string graphResourceID = ConfigurationManager.AppSettings["ida:OutlookResourceID"];
            ...
            try
            {
                ...
                var tmpResult = await graphService.GetMyOutlookTasks(authResult.AccessToken);
